...
import { minutesToDecimal, travelMinutes, workedMinutes, type WorkerSummary } from './data'
...
export function exportXlsx(summaries: WorkerSummary[], period: string, t: TFunction): void {
  ...
  const summaryRows = [
    ...
    [],
    [t('admin.worker'), t('admin.days'), t('admin.workH'), t('admin.travelH'), t('admin.lunchH'), t('admin.totalH')],
    ...summaries.map((s) => [
      s.userName,
      s.days,
  ...
  wsSummary['!cols'] = [{ wch: 28 }, { wch: 7 }, { wch: 10 }, { wch: 10 }, { wch: 10 }, { wch: 10 }]
  ...
  wsDetails['!cols'] = [{ wch: 24 }, { wch: 11 }, { wch: 34 }, { wch: 8 }, { wch: 8 }, { wch: 10 }, { wch: 9 }, { wch: 10 }]
