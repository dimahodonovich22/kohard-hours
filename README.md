...
**Работник** (с телефона): отмечает приезд на объект и отъезд с живой фотографией с камеры, при приезде вводит свою ставку (€/час), указывает обед и дорогу. При закрытии смены сразу видит, сколько отработал и сколько заработал; в истории — часы и заработок за неделю/месяц. Интерфейс на украинском и русском.
